...
<head>
    ...
    <title>Mahayana Shuttle - Cianjur</title>
...
<main class="pb-32">
    ...
    <div class="relative h-64 w-full overflow-hidden">
        ...
        <div class="absolute inset-0 bg-navy-dark/70 flex flex-col items-center justify-center text-center px-4">
            ...
            <p class="text-white text-5xl font-black uppercase tracking-tighter shadow-sm">Cianjur</p>
    ...
    <!-- BANTUAN SECTION (STRUKTUR SEMULA) -->
...
routeSelect.addEventListener('change', function () {
    let id = this.value;
    if (scheduleMap[id]) {
        // Hanya set jika user belum memilih tanggal manual
        if (!dateInput.value) {
